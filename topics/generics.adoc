...
Generics is mainly a compiler feature. In java (at least the versions up to this moment, March 2026) it
...
Auto-boxing is automatically converting/wrapping an `int` into an `Integer` (auto-box) when a
