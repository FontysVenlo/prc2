...
image:lamp-battery-switch.gif[title="simple switch circuit, from 'https://electronics.stackexchange.com/'"] A state machine
...
image:railway-switch.gif[title="railway switch from 'https://en.wikipedia.org/wiki/Railroad_switch'"] As another analogy, you can think of a railway switch.
