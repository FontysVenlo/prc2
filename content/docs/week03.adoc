...
Last week we discussed REST interfaces and up till now we have been unit testing and testing manually.
...
Hint: you can also add a initialize the database container with a script, so you don't have with an empty database.
...
Isolated tests, have the advantage (besides being more scalable), is that they put pressure on the design of your application:
