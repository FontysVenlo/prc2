---
title: "Welcome"
date: 2026-02-02T15:04:33+01:00
draft: false
---
...
(Programming Concepts 2: the Test-Driven Way), starting in February 2026.

Responsible Teachers for 2026 PRC2:
...
*Best* is to do that before next week's lesson, so that even if you were not able to
finish, you will at least have some questions.
...
The answer is surprisingly simple: at the requirements of a class, method or whatever you want to develop. And always start at the simple end.
